ALTER TABLE public.automation_dispatch_events
  DROP CONSTRAINT IF EXISTS automation_dispatch_events_source_kind_check;

ALTER TABLE public.automation_dispatch_events
  ADD CONSTRAINT automation_dispatch_events_source_kind_check
  CHECK (source_kind IN ('assignment', 'trigger', 'flow', 'manual_retry'));
