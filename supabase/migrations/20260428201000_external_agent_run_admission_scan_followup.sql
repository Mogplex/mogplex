-- Re-apply the corrected RPC for databases that already ran
-- 20260428180000_external_agent_run_safety_followup.sql before this follow-up.
-- Safe to apply on any database; CREATE OR REPLACE keeps this idempotent.
