...
const REASON_LABELS: Record<string, string> = {
  ...
  REPO_CONCURRENCY_LIMIT: "Repository run limit reached",
  INSTALLATION_CONCURRENCY_LIMIT: "Installation run limit reached",
  ACCOUNT_CONCURRENCY_LIMIT: "Parallel agent runs full",
