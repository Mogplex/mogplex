-- Ported from supabase/migrations/20260814193000_parallel_chat_admission.sql
-- (PR #224, 2026-08-14). That file was committed after the database moved to
-- Neon and the deploy pipeline stopped applying the Supabase folder, so
-- production kept the April admission function that blocks a new Control chat
-- while another is active. The Neon migration runner owns this transaction.
